...
const std::map<ChannelType, Channel> CHANNELS = {
    {SETTINGS_CHANNEL, {"settings", "127.0.0.1", "5563"}},
    {AI_PRIMARY_DATA_CHANNEL, {"primary_ai_data", "127.0.0.1", "5564"}},
    {AI_SECONDARY_DATA_CHANNEL, {"secondary_ai_data", "127.0.0.1", "5565"}},
